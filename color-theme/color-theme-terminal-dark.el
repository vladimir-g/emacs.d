(defun color-theme-terminal-dark ()
  "Color theme by Vladimir Gorbunov from dark transparent terminal, created 2010-07-03."
   (interactive)
   (color-theme-install
    '(color-theme-terminal-dark
      ...
      (comint-highlight-prompt ((t (:foreground "#5b5bc7"))))
      ...
      (font-lock-builtin-face ((t (:foreground "#d7ffff"))))
      ...
      (font-lock-function-name-face ((t (:bold t :foreground "#afffff" :weight bold))))
      (font-lock-keyword-face ((t (:bold t :foreground "#7d7dfb" :weight bold))))
      ...
      (font-lock-variable-name-face ((t (:foreground "#ffd7af"))))
      ...
      (italic ((t (:italic t :slantp italic))))
      ...
      (show-paren-match-face ((t (:bold t :foreground "green" :background "steelblue3" :weight bold))))
...
(add-to-list 'color-themes '(my-color-theme  "Terminal Dark" "Vladimir Gorbunov"))