;; Color theme based on Deep Blue by Thomas Cerha and colors of KDE4 Obsidian Coast theme. 
;; Created by Vladimir "ZaZa" Gorbunov, truedaemon@gmail.comw
(defun color-theme-deep-dark ()
   "Color theme by Vladimir Gorbunov."
   (interactive)
   (color-theme-install
    '(color-theme-deep-dark
...
(add-to-list 'color-themes '(my-color-theme  "Deep Dark" "Vladimir Gorbunov"))