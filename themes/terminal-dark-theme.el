...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(link-visited ((,class (:underline t :foreground "#3465a4"))))
   ;; Gnus faces
   ...
   `(ediff-current-diff-C ((,class (:background "#48481b"))))
   `(ediff-fine-diff-C ((,class (:background "#626213"))))
   `(ediff-odd-diff-C ((,class (:background ,alum-5.5))))
   `(ediff-even-diff-C ((,class (:background "#626262"))))
   ;; Flyspell faces
